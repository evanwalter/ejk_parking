...
if ($fee=="0.00"){
	...
	end_parking_event($conn, $parking_event_id,$fee_amount,$current_datetime,$payment_id);
		...
		echo "Name on card: <input type=\"text\" name=\"nameoncard\" ><br>";
		echo "Card Number: <input type=\"text\" name=\"number\" ><br>";
		echo "Month: <input type=\"text\" name=\"month\" ><br>";
		echo "Year: <input type=\"text\" name=\"year\" ><br>";
		echo "accesscode: <input type=\"text\" name=\"accesscode\" ><br><br><br>";
		echo "<input class=\"btn btn-primary\" type=\"button\" value=\"submit\"   >";
		echo "</div>";
}
